...
# This decorator tells Flask to trigger the show_number_odd_or_even_template(n)
# function when the ‘/number_odd_or_even/<n>’ URL is visited. <n> is a variable
#  part of the URL and must be an integer.
@app.route('/number_odd_or_even/<int:n>', strict_slashes=False)
def Disp_number_odd_or_even_template(n):
    """Display a HTML page only if n is an integer show if odd or even;
    - This function is triggered when the user visits the
    ‘/number_odd_or_even/<n>’ URL. It uses Flask’s render_template function
    to render a HTML template named ‘6-number_odd_or_even.html’, passing <n>
    as a parameter to be used in that template. The template will determine
    if <n> is odd or even and display this information.
    """
